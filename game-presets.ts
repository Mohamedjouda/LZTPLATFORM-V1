...
export const gamePresets = {
  ...
  gifts: { name: 'Gifts', slug: 'gifts', category: 'Digital Goods', description: 'Digital gifts like Discord Nitro and Telegram Premium.', api_base_url: 'https://api.lzt.market', list_path: '/gifts', check_path_template: '/item/{id}/check-account', default_filters: { currency: 'usd' }, fetch_worker_enabled: true, check_worker_enabled: true, columns: [ { id: 'item_id', label: 'Item ID', type: 'core', is_numeric: true },{ id: 'title', label: 'Title', type: 'core', min_width: '20rem' }, { id: 'price', label: 'Price', type: 'core', is_numeric: true } ], filters: [], sorts: [] },
  ...
  tiktok: { name: 'TikTok', slug: 'tiktok', category: 'Social', description: 'TikTok accounts with followers and likes.', api_base_url: 'https://api.lzt.market', list_path: '/tiktok', check_path_template: '/item/{id}/check-account', default_filters: { currency: 'usd' }, fetch_worker_enabled: true, check_worker_enabled: true, columns: [ { id: 'item_id', label: 'Item ID', type: 'core', is_numeric: true },{ id: 'title', label: 'Title', type: 'core', min_width: '20rem' }, { id: 'price', label: 'Price', type: 'core', is_numeric: true }, { id: 'tt_followers', label: 'Followers', type: 'game_specific', is_numeric: true } ], filters: [], sorts: [] },
  ...
  chatgpt: { name: 'ChatGPT', slug: 'chatgpt', category: 'AI / Services', description: 'OpenAI ChatGPT accounts, often with Plus subscriptions.', api_base_url: 'https://api.lzt.market', list_path: '/chatgpt', check_path_template: '/item/{id}/check-account', default_filters: { currency: 'usd' }, fetch_worker_enabled: true, check_worker_enabled: true, columns: [ { id: 'item_id', label: 'Item ID', type: 'core', is_numeric: true },{ id: 'title', label: 'Title', type: 'core', min_width: '20rem' }, { id: 'price', label: 'Price', type: 'core', is_numeric: true }, { id: 'chatgpt_subscription', label: 'Subscription', type: 'game_specific' } ], filters: [], sorts: [] },
  vpn: { name: 'VPN', slug: 'vpn', category: 'Services', description: 'VPN service subscriptions.', api_base_url: 'https://api.lzt.market', list_path: '/vpn', check_path_template: '/item/{id}/check-account', default_filters: { currency: 'usd' }, fetch_worker_enabled: true, check_worker_enabled: true, columns: [ { id: 'item_id', label: 'Item ID', type: 'core', is_numeric: true },{ id: 'title', label: 'Title', type: 'core', min_width: '20rem' }, { id: 'price', label: 'Price', type: 'core', is_numeric: true }, { id: 'vpn_service', label: 'Service', type: 'game_specific' } ], filters: [], sorts: [] },
