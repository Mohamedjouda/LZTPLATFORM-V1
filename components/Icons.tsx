...
export const SunIcon: React.FC<IconProps> = (props) => (
  // FIX: Corrected a typo in the viewBox attribute. It had an extra quote which was breaking the JSX parsing.
...
export const GameIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M6 12h4" />
        <path d="M8 10v4" />
        <path d="M12.5 18.5 A9.5 9.5 0 1 0 3.5 8.5" />
        <path d="M18 12h.01" />
        <path d="M21 15h.01" />
    </svg>
);
...
export const ArchiveRestoreIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <rect width="20" height="5" x="2" y="3" rx="1" />
    <path d="M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8" />
